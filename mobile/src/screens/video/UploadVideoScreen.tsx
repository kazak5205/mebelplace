...
const UploadVideoScreen = ({ navigation }: any) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      Alert.alert('Ошибка', 'Произошла ошибка при загрузке видео');
    } finally {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Title style={styles.headerTitle}>Загрузить видео</Title>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.card}>
          <Card.Content>
            <Title style={styles.cardTitle}>Детали видео</Title>
        ...
        {isUploading && (
          <Card style={styles.card}>
            <Card.Content>
              <Title style={styles.cardTitle}>Загрузка видео</Title>
